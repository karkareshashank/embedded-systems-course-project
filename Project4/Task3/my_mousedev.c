...
#define MOUSEDEV_MINOR_BASE	100
#define MOUSEDEV_MINORS		100
#define MOUSEDEV_MIX		99
					...
					int minor)
{
	...
	if (minor == MOUSEDEV_MIX)
		dev_set_name(&mousedev->dev, "my_mice");
	else
		dev_set_name(&mousedev->dev, "my_mouse%d", minor);
...
static struct miscdevice psaux_mouse = {
	PSMOUSE_MINOR, "my_psaux", &mousedev_fops
};
